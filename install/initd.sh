#!/bin/bash
#--------------------------------------------------
# ----- Tüm gerekli yapılandırmalarla debian kurulum dosyası oluşturma
#--------------------------------------------------


OE_AUTO_SCRIPTS_DIR=$OE_HOME/$proje-$OE_VERSION
...
Version: $OE_PORT
Architecture: all
Maintainer: Autoronics <info@autoronics.com>
Section: net
Priority: optional
Homepage: http://www.autoronics.com/
...
#--------------------------------------------------
# init.d script ekleme
#--------------------------------------------------


echo -e "-------------------"
echo -e "* init.d dosyası oluşturuluyor"
echo -e "-------------------"
cat <<EOF > $OE_INIT
#!/bin/sh
### BEGIN INIT INFO
...
echo -e "--------------------------------------"
echo -e "* Init dosya güvenliğinin sağlanması"
echo -e "--------------------------------------"
