# --------------------------------------
# Apache2 kurulum bölümü
# --------------------------------------

if [ $WEB_SERVER = "apache2" ]; then

echo -e "----------------------"
echo -e "* $WEB_SERVER kütüphanesi kuruluyor"
echo -e "----------------------"
sudo apt-get install -y $WEB_SERVER

echo -e "--------------------------------"
echo -e "Odoo yu Apache ile Yapılandırma"
echo -e "--------------------------------"

echo -e "------------------------------------"
echo -e "* Apache modülleri etkinleştiriliyor"
echo -e "------------------------------------"
sudo a2enmod proxy 
...
echo -e "---------------------------------------"
echo -e "* Apache2 için config ayarları yükleniyor."
echo -e "---------------------------------------"
...
echo -e "* Siteyi etkinleştir"
a2ensite $OE_WEBSERV_CONF

echo -e "* Varsayılan siteleri devre dışı bırak"
